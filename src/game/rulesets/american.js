/**
 * Classic American Draw Dominoes — engine id "american".
 *
 * Not selectable. Product American maps to the allFives engine. This
 * wrapper stays registered so in-progress Classic Draw `american` saves
 * can still resume.
 *
