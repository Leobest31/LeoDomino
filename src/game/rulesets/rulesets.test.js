...
// --- Registry resolution ---
{
  ...
  assert.equal(isKnownRulesetId("allFives"), true, "legacy allFives still accepted");
  ...
  assert.equal(tryResolveRuleset("allFives")?.id, "american", "allFives → american");
  ...
  assert.equal(coerceRulesetId("allFives"), "american");
