...
assert.deepEqual(buildOfflinePlayerIds(2), ["you", "leoBest"]);
assert.deepEqual(buildOfflinePlayerIds(3), ["you", "leoBest", "rival-2"]);
assert.deepEqual(buildOfflinePlayerIds(4), ["you", "leoBest", "rival-2", "rival-3"]);
